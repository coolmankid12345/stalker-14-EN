...
command-description-solution-get = Возвращает решение, хранящееся в контейнере раствора сущности.
...
command-description-stationevent-simulate = Симулирует N количество раундов, в которых будут происходить события, и выводит статистику по каждому событию после.
command-description-rdwatcher-list = Выводит список всех RD watcher сущностей и их отслеживаемых сущностей.
command-description-ares-save = Сохраняет все RD area сущности в их содержащий grid.
command-description-ares-load = Загружает все RD areas из их содержащего grid.
