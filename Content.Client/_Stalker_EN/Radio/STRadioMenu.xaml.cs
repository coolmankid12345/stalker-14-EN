...
/// <summary>
/// UI menu for the stalker handheld radio.
/// Shows mic + speaker toggles (mutually exclusive) and split frequency input (XXX.Y format).
/// </summary>
[GenerateTypedNameReferences]
public sealed partial class STRadioMenu : FancyWindow
{
    /// <summary>
    ...
    private const string DefaultFrequency = "120.0";
    ...
    public void Update(RadioStalkerBoundUIState state)
    {
        ...
        var frequency = state.CurrentFrequency ?? DefaultFrequency;
